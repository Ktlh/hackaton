...
(function ($) {
    ...
    $.jcarousel = function (e, o) {
        ...
        this.clip.addClass(this.className('jcarousel-clip')).css({overflow: 'hidden', position: 'relative' ,height: '400px'});
        this.list.addClass(this.className('jcarousel-list')).css({overflow: 'hidden', position: 'relative', top: 75, left: 0, margin: 0, padding: 0});
